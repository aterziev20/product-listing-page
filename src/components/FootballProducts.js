...
const FootballProducts = () => {
  ...
  const footballProducts = allProducts.filter(
    (product) => product.sport.toLowerCase() === "football"
  );
  ...
  useEffect(() => {
    const sortedProducts = applySorting(footballProducts);
      ...
      <div className="load-more">
        {filteredProducts.length > visibleProductsCount && (
          <LoadMore
            ...
            totalProducts={footballProducts.length}
